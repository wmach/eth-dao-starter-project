...
const Home: NextPage = () => {
  ...
  const editionDrop = useContract("0x0166614A5F65A7F1930c7Ef584305f1c071A275e", "edition-drop").contract;
  const token = useContract("0x587D7a11c39a998Ed861De0d342c0fAD05057Ce9", "token").contract;
  // 投票コントラクトの初期化
  const vote = useContract("0x2D83e626Ab586A16D84689e22E929b266368171c", "vote").contract;
